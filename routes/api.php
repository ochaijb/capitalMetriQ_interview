...
Route::post('transaction/create', [TransactionsController::class, 'store'])->middleware('auth:api');
Route::get('transaction/history', [TransactionsController::class, 'history'])->middleware('auth:api');
